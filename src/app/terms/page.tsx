  ...
  return (
    <PageLayout
      ...
      <Container className='py-3' fluid>
        <Row>
          <Col>
            <Container id='terms-content-wrapper' className='shadow-lg p-3 p-md-4 bg-body rounded'>
              <Row className='justify-content-md-center'>
                <Col lg={9} xl={8}>
                  <div style={{ padding: '10px' }}>
                    <h1 className='text-center mb-4'>Web Site Terms and Conditions of Use</h1>
                    <hr className='mb-4' />
                    ...
                    <section className='mt-4'>
                      ...
                      <ol type='a'>
                        <li>
                          ...
                          (information or software) on Techreanimate&apos;s web site for personal,
                        ...
                        <li>
                          ...
                          restrictions and may be terminated by Techreanimate at any time. Upon
                    ...
                    <section className='mt-4'>
                      ...
                      <ol type='a'>
                        <li>
                          The materials on Techreanimate&apos;s web site are provided &quot;as
                          is&quot;. Techreanimate makes no warranties, expressed or implied, and
                          ...
                          other violation of rights. Further, Techreanimate does not warrant or make
                    ...
                    <section className='mt-4'>
                      <h3>4. Limitations</h3>
                      <p>
                        In no event shall Techreanimate or its suppliers be liable for any damages
                        ...
                        materials on Techreanimate&apos;s Internet site, even if Techreanimate or a
                        Techreanimate authorized representative has been notified orally or in
                    ...
                    <section className='mt-4'>
                      ...
                      <p>
                        The materials appearing on Techreanimate&apos;s web site could include
                        technical, typographical, or photographic errors. Techreanimate does not
                        warrant that any of the materials on its web site are accurate, complete, or
                        current. Techreanimate may make changes to the materials contained on its
                        web site at any time without notice. Techreanimate does not, however, make
                    ...
                    <section className='mt-4'>
                      <h3>6. Links</h3>
                      <p>
                        Techreanimate has not reviewed all of the sites linked to its Internet web
                        site and is not responsible for the contents of any such linked site. The
                        inclusion of any link does not imply endorsement by Techreanimate of the
                    ...
                    <section className='mt-4'>
                      ...
                      <p>
                        Techreanimate may revise these terms of use for its web site at any time
                    ...
                    <section className='mt-4'>
                      ...
                      <p>
                        Any claim relating to Techreanimate&apos;s web site shall be governed by the
                    ...
                    <section className='mt-5'>
                      ...
                      <ul className='list-unstyled mt-3'>
                        <li className='mb-2'>
                          <span className='fw-semibold'>Purpose Identification:</span> Before or at
                          the time of collecting personal information, we will identify the purposes
                          for which information is being collected.
                        </li>
                        <li className='mb-2'>
                          <span className='fw-semibold'>Consent & Use Limitation:</span> We will
                          collect and use personal information solely with the objective of
                        ...
                        <li className='mb-2'>
                          <span className='fw-semibold'>Data Retention:</span> We will only retain
                          personal information as long as necessary for the fulfillment of those
                          purposes.
                        </li>
                        <li className='mb-2'>
                          <span className='fw-semibold'>Collection Method:</span> We will collect
                          personal information by lawful and fair means and, where appropriate, with
                          the knowledge or consent of the individual concerned.
                        </li>
                        <li className='mb-2'>
                          <span className='fw-semibold'>Data Quality:</span> Personal data should be
                        ...
                        <li className='mb-2'>
                          <span className='fw-semibold'>Security Safeguards:</span> We will protect
                          personal information by reasonable security safeguards against loss or
                          theft, as well as unauthorized access, disclosure, copying, use or
                          modification.
                        </li>
                        <li className='mb-2'>
                          <span className='fw-semibold'>Openness:</span> We will make readily
                          available to customers information about our policies and practices
