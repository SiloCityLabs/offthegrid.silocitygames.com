              ...
              <Row className='justify-content-md-center'>
                <Col lg={9} xl={8}>
                  ...
                  <p className='lead mb-4'>
                    This Privacy Policy governs the manner in which Techreanimate collects, uses,
                    ...
                    products and services offered by Techreanimate.
                  </p>
                  ...
                  <section className='mt-4'>
                    ...
                    <p>
                      ...
                      enter your: name, e-mail address, mailing address, phone number or other
                      details. You may, however, visit our site anonymously.
                    </p>
                  </section>
                  ...
                  <section className='mt-4'>
                    ...
                    <ul className='list-group list-group-flush mt-3 mb-3'>
                      <li className='list-group-item ps-0'>
                        <strong>To personalize your experience:</strong> Your information helps us
                        to better respond to your individual needs.
                      </li>
                      <li className='list-group-item ps-0'>
                        <strong>To improve our website:</strong> We continually strive to improve
                        our website offerings based on the information and feedback we receive from
                        you.
                      </li>
                      <li className='list-group-item ps-0'>
                        <strong>To improve customer service:</strong> Your information helps us to
                        more effectively respond to your customer service requests and support
                        needs.
                      </li>
                      <li className='list-group-item ps-0'>
                        <strong>To process transactions:</strong> Your information, whether public
                        or private, will not be sold, exchanged, transferred, or given to any other
                      ...
                      <li className='list-group-item ps-0'>
                        <strong>To administer features:</strong> Such as a contest, promotion,
                        survey or other site feature.
                      </li>
                      <li className='list-group-item ps-0'>
                        <strong>To send periodic emails:</strong> The email address you provide may
                        be used to send you information and updates, in addition to receiving
                        occasional company news, updates, etc.
                  ...
                  <section className='mt-4'>
                    ...
                    <p>
                      We may offer the use of a secure server. All supplied sensitive/credit
                    ...
                    <p>
                      ...
                      numbers, financials, etc.) may not be stored on our servers.
                    </p>
                  </section>
                  ...
                  <section className='mt-4'>
                    ...
                    <p>
                      ...
                      Protection Act), we do not knowingly collect any information from anyone under
                      13 years of age. Our website, products and services are all directed to people
